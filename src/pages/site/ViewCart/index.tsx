    ...
    <div className='view-cart'>
      <div className='view-cart__wrap'>
        <div className='container'>
          <h2 className='view-cart__title'>{t('cart.shoping')}</h2> {/* Shopping Cart */}
          <div className='view-cart__content '>
            <Row className='row-wrap'>
              <Col md={18} sm={24}>
                <div className='view-cart__list'>
                  <h4 className='view-cart__list-title'>{cart?.items?.length || 0} {t('cart.incart')}</h4> {/* Courses in Cart */}
              ...
              <Col md={6} className='col view-cart__right'>
                <div className='view-cart__summary'>
                  <h4 className='view-cart__summary-title'>{t('cart.total')} </h4>{/* Total: */}
                  <h3 className='view-cart__summary-price'>${totalPrice}</h3>
                  <div onClick={checkoutHandler}>
                    <div className='view-cart__summary-btn btn btn-md'>{t('cart.checkout')}</div> {/* Checkout */}
                  </div>
                  <Divider />
                  <div className='view-cart__summary-promo'>
                    <span className='view-cart__summary-promo-title'>{t('cart.promocode')}</span>{/* Promo code */}
                    {courseIds.length > 0 && (
