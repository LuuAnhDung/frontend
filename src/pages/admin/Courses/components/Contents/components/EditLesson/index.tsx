...
const EditLesson: React.FC<EditLessonProps> = ({ isVisible, onClose, lesson, section }) => {
  ...
  // const onFinish = async (values: ILesson) => {
  //   try {
  //     const videoLengthValue = uploadMethod === 'video' ? videoDuration : 0;
      
  //     const contentData =
  //       uploadMethod === 'linkYoutube'
  //         ? contentLink
  //         : uploadMethod === 'uploadPdf'
  //         ? uploadedPDFPath // URL từ Cloudinary cho PDF
  //         : uploadedVideoPath; // Video path từ file upload
  ...
  //         ...values,
  //         content: contentData,
  //         videoLength:  videoLengthValue // Độ dài video chỉ cho video
  //         // contentType: uploadMethod, // Loại nội dung (video, pdf, hoặc linkYoutube)
  //       },
  //     }).unwrap();
