      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className='flex justify-between mb-8 items-center'>
            ...
            <img
              // src={user?.user.avatar ? user.user.avatar : 'https://placehold.co/150'}
              src={
                user?.user.avatar instanceof File
                  ? URL.createObjectURL(user.user.avatar)
                  : user?.user.avatar || 'https://placehold.co/150'
              }
              alt='avatar'
